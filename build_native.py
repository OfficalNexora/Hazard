...
NATIVE_DIR = os.path.join(ROOT_DIR, "nexora_native")
...
def build_server_exe():
    ...
    cmd = [
        ...
        "--add-data", f"{NATIVE_DIR};nexora_native",
        ...
        "--hidden-import", "cv2",
        "--hidden-import", "websockets",
        "--hidden-import", "nexora_native.data_bridge",
        "--hidden-import", "nexora_native.dashboard",

        "nexora_native/native_launcher.py"
    ]
    run_command(cmd)
