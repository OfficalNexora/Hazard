...
const navItems = [
    ...
    { name: "Weather", href: "/weather", icon: (props: any) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17.5 19c0-1.7-1.3-3-3-3h-9c-1.7 0-3 1.3-3 3v2h15v-2z" /><path d="M17.5 19a6.5 6.5 0 0 0 0-13 6.5 6.5 0 0 0-5 2.3 6.5 6.5 0 0 0-7.8 8.4" /></svg> }, // Cloud
